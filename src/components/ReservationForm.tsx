  ...
  return (
    <div className="flex justify-center items-center">
      <button
        ...
        className="bg-secondary text-white px-4 py-2 rounded-lg drop-shadow-lg"
      >
      ...
      >
        <div className="bg-white px-8 py-4 rounded shadow-lg w-full max-w-md">
          <h2 className="text-center px-4 pb-2 text-slate-700 font-semibold text-lg">Let's Chat!</h2>
