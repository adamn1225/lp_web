...
const TextArea: React.FC = () => {
    ...
    return (
        <>
            <form onSubmit={handleSubmit} className="px-4 w-full text-slate-800 text-sm mb-4 max-h-36 overflow-y-auto my-4 border border-gray-500/50 relative">
                <button
                    type="button"
                    onClick={openModal}
                    className="absolute top-0 right-0 mt-2 mr-2 bg-blue-500 text-white py-1 px-2 rounded"
                >
                    <span>&#x2191;&#x2193; Expand</span>
                </button>
                ...
                contentLabel="Expanded Text Area"
            ...
            >
                <div className="flex flex-col h-full">
                    <button
                        type="button"
                        onClick={closeModal}
                        className="self-end bg-red-500 text-white py-1 mb-2 px-2 rounded"
                    >
                        Close
                    </button>
                    <div className="text-display w-full p-2 border border-gray-300 rounded flex-grow">
                <strong><h2 className='text-lg mb-2'>Rental Agreement</h2></strong>
                <strong><p>Agreement between User and line-properties.com</p></strong>
